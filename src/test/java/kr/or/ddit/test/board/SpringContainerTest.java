...
public class SpringContainerTest {
	...
	// name : 스프링 빈 이름
	// boardDao라는 이름의 스프링 빈을 스프링 컨테이너로부터 찾아서  boardDao 필드에 주입
	...
	*/
	...
	public void springBeanScopeTest() {
		...
		//디자인 패턴 관점에서 보면 boardDaoS1과  boardDaoS2는 같은 클래스로부터 생성 되었으므로 같아야 하지만,
		// 스프링 컨테이너에서 관리되는 scope에 개념에 따라 다른 객체로 관리된다
